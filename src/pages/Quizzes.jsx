      ...
      <div className="screen with-nav">
        ...
        {overallPct !== null && (
          <div className="overall-compat-banner">
            {doneCount} of {totalSubtopics} quizzes done · {overallPct}% in sync overall
          </div>
        )}
          ...
          {Object.entries(topic.subtopics).map(([subtopicKey, subtopic], i) => {
            ...
            return (
              ...
              >
                ...
                {status.done ? (
                  <div className="quiz-tile-badge done">{status.myGuessPct}% you guessed right</div>
                ) : status.mine ? (
  ...
  return (
    <>
      <div className="quiz-score-card">
        {status.myGuessPct === 100 && status.theirGuessPct === 100 && <Confetti />}
